 ...
 * already exists for this email. If they do update them. Otherwise,
 ...
 * @param  {Facade}   identify || group TODO: Create a mapper to map identify traits to Lead traits
 * @param  {Object}   settings
 * @param  {Function} callback  (err, user)
 * @api private
 */
...
Close.prototype._createContact = function(identify, settings, callback){
  // identify.websites might not be the best thing to key on for Leads
  ...
  else self._updateLead(identify, setting, callback);
